...
clf
% % 已知theta_O在O系
% theta_O_double = [0/180*pi, 10/180*pi, 60/180*pi, 90/180*pi]'; 
% % 已知Om系原点在O系坐标
% Om_O_double = [[0, 0]', [100, 15]', [310, 20]', [500, 80]'];
...
% % 已知theta_O在O系
% theta_O_double = [0.5/180*pi, -0.5/180*pi, 0.5/180*pi, 26/180*pi]'; 
% % 已知Om系原点在O系坐标
% Om_O_double = [[500, 0]', [250, 0]', [0, 0]', [-500, -500]'];
...
p_c_Om_double = [50; 0200]; % 圆点在连杆系坐标（手动修改）
...
% 
% % 选定一个x坐标
% num_x =  vpa(solve(subs(num(1), Pm_Om1, p_c_Om_double(1))));
% p_c_Om_double(2) = num_x(2);
% subplot(3, 3, 4);
% hold on
% plot(p_c_Om_double(1), p_c_Om_double(2), 'b*');
% hold off
